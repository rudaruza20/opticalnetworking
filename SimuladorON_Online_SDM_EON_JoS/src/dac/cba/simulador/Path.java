...
public class Path implements Comparable <Path>, Cloneable {
	//Lightpath: set of nodes, links and frequency slots. Can be used to multiple demands in case of group sharing
	private ArrayList<Integer> id = new ArrayList<Integer>(); //These id are all demands served with the same light-path, and then after holding-time we can release the cores&spectrum of demand id 
	...
	private int n_OC; //number of OCs per spatial channel (for S2-SCh) or number of OCs per Spa-SCh
